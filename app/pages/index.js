...
const Home = () => {
    const { initialized, initializeStaticUser, loading, transactionPending, completedTodos,
        incompleteTodos, addTodo, markTodo, removeTodo, markStaticTodo,removeStaticTodo,
        addStaticTodo, input, handleChange } = useTodo()
        ...
        <div className={styles.container}>
            <div className={styles.actionsContainer}>
                {initialized ? (
                    ...
                    <div className={styles.todoInput}>
                        ...
                        <div className={styles.inputContainer}>
                            <form onSubmit={addStaticTodo}>
                                <input value = {input} onChange={handleChange} id={styles.inputField} type="text" placeholder='Add Data...' />
                            </form>
                        </div>
            ...
            <div className={styles.mainContainer}>
                <Loading loading={loading}>
                    ...
                    <TodoSection title="Successfully Added" todos={completedTodos} action={removeStaticTodo} />
                </Loading>
            </div>
        </div>
    )
